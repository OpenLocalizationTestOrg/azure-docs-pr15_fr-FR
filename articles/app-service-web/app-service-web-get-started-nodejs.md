<properties 
    pageTitle="Déployez votre application web Node.js pour Azure de cinq minutes | Microsoft Azure" 
...
# <a name="deploy-your-first-nodejs-web-app-to-azure-in-five-minutes"></a>Déployez votre application web Node.js première pour Azure de cinq minutes

Ce didacticiel vous aide à déployer votre application web Node.js première [Azure application](../app-service/app-service-value-prop-what-is.md)service.
...
- Déployer des exemples de code Node.js.
...
4. Créer la ressource de l’application de Service d’application dans Azure avec un nom d’application unique et de l’utilisateur de déploiement que vous avez configuré précédemment. Lorsque vous êtes invité, indiquez le nombre de la région souhaitée.
    ...
    ![Créer la ressource Azure pour votre application web première dans Azure](./media/app-service-web-get-started-languages/node-site-create.png)
...
4. Déployez votre exemple de code dans votre application Azure comme vous le feriez transmission de code avec Git. Lorsque vous y êtes invité, utilisez le mot de passe que vous avez configuré précédemment.
    ...
    ![Code d’épingle dans votre application web première dans Azure](./media/app-service-web-get-started-languages/node-git-push.png)
...
[Créer, configurer et déployer une application web Node.js Express vers Azure](app-service-web-nodejs-get-started.md). En suivant ce didacticiel, vous allez apprendre les notions de base que vous devez exécuter une application web Node.js dans Azure, telles que :

- Créer et configurer des applications dans Azure à partir de PowerShell/Bash.
- Définissez Node.js version.
