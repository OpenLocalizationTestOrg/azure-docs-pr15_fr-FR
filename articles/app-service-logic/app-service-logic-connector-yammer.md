<properties
   pageTitle="L’utilisation du connecteur Yammer dans les applications logique | Service d’application Microsoft Azure"
   description="Comment créer et configurer l’application Connecteur Yammer ou API et l’utiliser dans une application logique dans le Service d’application Azure"
   services="logic-apps"
...
# <a name="weve-improved-the-yammer-connector"></a>Nous avons amélioré le lien Yammer 
