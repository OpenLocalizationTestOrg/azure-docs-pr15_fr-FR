<properties
   pageTitle="Partenaires SQL données Warehouse Business Intelligence | Microsoft Azure"
   description="Listes des partenaires d’intelligence métier tiers avec les solutions qui prennent en charge SQL Data Warehouse."
...
# <a name="sql-data-warehouse-business-intelligence-partners"></a>Partenaires de SQL Data Warehouse business intelligence

Pour créer votre solution d’entrepôt de données de bout en bout, sélectionnez à partir d’un large éventail d’outils de pointe.  Cet article met en évidence les partenaires Microsoft avec Azure SQL Data Warehouse de prise en charge des solutions business intelligence (BI).

## <a name="our-business-intelligence-partners"></a>Partenaires business intelligence

| Partenaire | Description | Liens | Vidéos |
| ------- | ----------- | ----- | ------ |
| ![Birst][1] |**Birst**<br>Birst est un leader global BI Cloud et Analytique. Les entreprises peuvent créer une source de données dans le contexte de chaque utilisateur métiers clés fiable. Ensuite, utilisateurs professionnels de l’organisation peuvent signaler et analyser les informations avec des outils de décisionnel mondiales.| [Marketplace][birst_marketplace]<br>[Site Web][birst_website]<br>[Twitter][birst_twitter]<br>[YouTube][birst_youtube] | |
| ![Données clearStory][2] |**Données clearStory**<br>Données clearStory permet d’analyse rapide cycle dans l’ensemble des données hétérogènes stockées dans SQL Data Warehouse. ClearStory intégrée basée sur explosion plateforme et analytique application vitesse accès aux données et rapprochement des jeux de données hétérogènes. Ils permettent d’exploration rapide et collaborative qui permet aux utilisateurs professionnels de travailler de manière autonome pour obtenir des idées.| [Site Web][clearstory_website]<br>[Feuille de données][clearstory_datasheet]<br>[Twitter][clearstory_twitter]<br>[YouTube][clearstory_youtube] | |
| ![Statistique Dell][3] |**Statistique Dell**<br>Dell statistique est une plateforme analytique avancée qui permet aux organisations de réaliser des prévisions concernant l’avenir, optimiser les processus, réduire les coûts et augmenter le chiffre d’affaires.  Statistique Dell simplifie analytique de données volumineux, simplifie la mise en œuvre et déploiement, extrait les informations pratiques du texte et permet à votre entreprise. | [Marketplace][dell_statistica_marketplace]<br>[Site Web][dell_statistica_website]<br>[Feuille de données][dell_statistica_datasheet]<br>[Twitter][dell_statistica_twitter]<br>[YouTube][dell_statistica_youtube] | [![Statistique vidéo](./media/sql-data-warehouse-partner-business-intelligence/dell_statistica_video.jpg)](https://www.youtube.com/watch?v=0b8sPW2UHrU) |
| ![Dundas][4] |**Dundas BI**<br>Visualisation des données Dundas est un fournisseur non significatif, global du logiciel à la décision et de visualisation des données.  Analytique visuelle des données, de création de rapports et de tableaux de bord Dundas fournir une intégration transparente dans les applications d’entreprise, l’activation de meilleures décisions et les idées plus rapides. | [Marketplace][dundas_bi_marketplace]<br>[Site Web][dundas_bi_website]<br>[Feuille de données][dundas_bi_datasheet]<br>[Twitter][dundas_bi_twitter]<br>[YouTube][dundas_bi_youtube] | [![vidéo Dundas](./media/sql-data-warehouse-partner-business-intelligence/dundas_bi_video.jpg)](https://www.youtube.com/watch?v=TEbc3_e7o60) |
| ![Jinfonet][5] |**JReport**<br>JReport est une solution BI intégrable pour les entreprises. La solution permet aux utilisateurs de créer des rapports, des tableaux de bord et analyse des données dans le cloud, big data et sources de données. En visualisation des données, vous pouvez effectuer votre propre découverte de création de rapports et des données pour la prise de décision agile, à la volée.| [Site Web][jinfonet_website]<br>[Feuille de données][jinfonet_datasheet]<br>[Twitter][jinfonet_twitter]<br>[YouTube][jinfonet_youtube] | [![jreport vidéo](./media/sql-data-warehouse-partner-business-intelligence/jinfonet_video.jpg)](https://www.youtube.com/watch?v=KYqh8TuMpds) |
| ![LogiAnalytics][6] |**Logique Analytique**<br>Ensemble, Analytique logique et Azure SQL Data Warehouse permet à votre organisation collecter et analyser immédiatement agir sur les jeux de données plus grandes et plus centralisée dans le monde. | [Marketplace][logianalytics_marketplace]<br>[Site Web][logianalytics_website]<br>[Feuille de données][logianalytics_datasheet]<br>[Twitter][logianalytics_twitter]<br>[YouTube][logianalytics_youtube] | [![logianalytics vidéo](./media/sql-data-warehouse-partner-business-intelligence/logianalytics_video.jpg)](https://www.youtube.com/watch?v=7U0Sfi3Ndpk) |
| ![Looker][7] |**Looker BI**<br>Looker tous les membres de votre entreprise donne la possibilité d’Explorer et de comprendre les données que les lecteurs de votre entreprise. Looker permet également l’analyste de données à un calque modélisation réutilisable et flexible pour contrôler et curate ces données.  Sociétés ont transformés fondamentalement leur culture en utilisant Looker comme celui-ci. | [Marketplace][looker_marketplace]<br>[Site Web][looker_website]<br>[Feuille de données][looker_datasheet]<br>[Twitter][looker_twitter]<br>[YouTube][looker_youtube] | [![looker vidéo](./media/sql-data-warehouse-partner-business-intelligence/looker_video.jpg)](https://www.youtube.com/watch?v=WwO4ADK8ZfA) |
| ![Qlik][8] |**Entreprise sens Qlik**<br>Découverte d’un aperçu de lecteur avec l’application de visualisation de données utilisables par tout le monde. Avec Qlik sens, tout le monde dans votre organisation peut facilement créer des visualisations flexibles et interactifs et prendre des décisions significatives.| [Site Web][qlik_website]<br>[Twitter][qlik_twitter]<br>[YouTube][qlik_youtube] | [![qlikview vidéo](./media/sql-data-warehouse-partner-business-intelligence/qlik_video2.jpg)](https://www.youtube.com/watch?v=VJEDFE-07Hg) |
