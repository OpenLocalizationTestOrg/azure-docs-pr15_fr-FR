...
Copiez et collez le code suivant à votre méthode **GetStartedDemo** en dessous de la création d’une base de données. Cela crée une collection de document nommée *FamilyCollection_va*.
